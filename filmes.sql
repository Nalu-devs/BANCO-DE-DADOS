...
insert into filme (titulo, diretor, ano, duracao_minutos)
values("Vida de inseto","John Lasseter", 1998, 95);
insert into filme (titulo, diretor, ano, duracao_minutos)
values("Toy Story 2","John Lasseter", 1999, 93);
insert into filme (titulo, diretor, ano, duracao_minutos)
values("Monstros S.A","Pete Docter", 2001, 92);
insert into filme (titulo, diretor, ano, duracao_minutos)
values("Procurando Nemo","Andrew Stanton", 2003, 107);
insert into filme (titulo, diretor, ano, duracao_minutos)
values("Os incriveis","Brad Bird", 2004, 116);
insert into filme (titulo, diretor, ano, duracao_minutos)
values("Carros","John Lasseter", 2006, 117);
insert into filme (titulo, diretor, ano, duracao_minutos)
...
insert into filme (titulo, diretor, ano, duracao_minutos)
values("Carros 2","John Lasseter", 2011, 120);
insert into filme (titulo, diretor, ano, duracao_minutos)
values("Coragem","Brepman", 2012, 102);
insert into filme (titulo, diretor, ano, duracao_minutos)
values("Universidade dos monstros","dan Scanlon", 2013, 110);

select titulo from filme; /*Encontre o titulo de cada filme*/
select diretor from filme; /*Encontre o diretor de cada filme*/
select titulo, diretor from filme; /*Encontre o titulo e o diretor de cada filme*/
select titulo, ano from filme; /*Encontre o titulo e o ano de cada filme*/
select * from filme; /*Mostre tudo da tabela filme*/
select * from filme where id=6; /*Encontre o filme com uma linha id 6*/
SELECT * FROM filme where ano>=2000 and ano<=2010; /*Encontre os filmes lançados na década de 2000 e 2010*/
